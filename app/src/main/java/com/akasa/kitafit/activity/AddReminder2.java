...
import com.akasa.kitafit.adapter.AlarmScheduler;
...
public class AddReminder2 extends AppCompatActivity implements
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(AddReminder2.this);
                    return true;
                }
